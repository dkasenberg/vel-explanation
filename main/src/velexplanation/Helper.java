...
public class Helper {
        ...
        return actionTypes.stream()
                .flatMap(t -> {
                    try {
                        ...
                        return new ArrayList<Action>().stream();
                    }
                })
    ...
    public static Set<HashableState> getAllReachableStates(SADomain d, State s0, HashableStateFactory hf) {
        ...
        while (!frontier.isEmpty()) {
            ...
            if (model.terminal(nextState)) continue;
    ...
    public static Set<HashableState> getAllReachableStates(MDPContainer mdp) {
        return getAllReachableStates(mdp.domain, mdp.initialState, mdp.hashingFactory);
    }
