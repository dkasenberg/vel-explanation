/* Generated By:JavaCC: Do not edit this line. VELParser.java */
...
public class VELParser implements VELParserConstants {
     ...
     */
    public VELParserTokenManager token_source;
    /**
     * Current token.
     */
    public Token token;
     ...
     */
    public VELParser(java.io.InputStream stream) {
        this(stream, null);
    }
     ...
     */
    public VELParser(java.io.InputStream stream, String encoding) {
        try {
            jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1);
        } catch (java.io.UnsupportedEncodingException e) {
            throw new RuntimeException(e);
        }
        token_source = new VELParserTokenManager(jj_input_stream);
        token = new Token();
        jj_ntk = -1;
        jj_gen = 0;
     ...
     * Constructor.
     */
    public VELParser(java.io.Reader stream) {
     ...
     */
    public VELParser(VELParserTokenManager tm) {
        token_source = tm;
        token = new Token();
        jj_ntk = -1;
        jj_gen = 0;
    ...
    public static Pair<List<VELObjective>, Comparator<RealVector>> parseFromText(Globals globals, String text, SADomain d, State s) throws ParseException {
        return new VELParser(globals, new StringReader(text)).parse(d, s);
    }
    ...
    final public Pair<List<VELObjective>, Comparator<RealVector>> weightedObjectives() throws ParseException {
        VELObjective result;
        ...
        {
            if (true) return new Pair<List<VELObjective>,
    ...
    final public VELObjective singleObjective() throws ParseException {
        ...
        formula = implication();
        {
            if (true) return new VELObjective((OOSADomain) d, formula, costlyVariables, quantifiedVariables,
    ...
    private boolean jj_3_11() {
        if (jj_scan_token(DUR)) return true;
        return false;
    }
     ...
     * Reinitialise.
     */
    public void ReInit(VELParserTokenManager tm) {
        token_source = tm;
        token = new Token();
        jj_ntk = -1;
        jj_gen = 0;
