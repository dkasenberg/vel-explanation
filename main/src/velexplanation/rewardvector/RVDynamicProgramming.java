...
public class RVDynamicProgramming extends MDPSolver implements VectorValueFunction, QVectorProvider {
     ...
     */
    public void DPPInit(SADomain domain, double gamma, HashableStateFactory hashingFactory, RewardVectorFunction rvf, int vectorSize, Comparator vectorCompare, boolean ignoreTF) {
    ...
    @Override
    public Comparator<RealVector> getComparator() {
    ...
    public RVDynamicProgramming getCopyOfValueFunction() {
        ...
        dpCopy.DPPInit(this.domain, this.gamma, this.hashingFactory, this.rvf, this.size, this.vectorCompare, this.ignoreTF);
    ...
    protected RealVector computeQ(State s, Action ga) {
        ...
        for (TransitionProb tp : tps) {
            ...
            RealVector valSp = this.rvf.rv(s, ga, sp).add(this.value(sp).mapMultiply(this.gamma));
