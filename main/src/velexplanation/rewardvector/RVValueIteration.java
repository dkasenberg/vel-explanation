...
public class RVValueIteration extends RVDynamicProgramming implements Planner {
    ...
    public RVValueIteration(SADomain domain, double gamma, HashableStateFactory hashingFactory, double maxDelta,
        ...
        this.DPPInit(domain, gamma, hashingFactory, rvf, vectorSize, vectorCompare, ignoreTF);
     ...
     */
    public void toggleReachabilityTerminalStatePruning(boolean toggle) {
...
//        HashMap<Integer,HashableState> hashCodeLookup = new HashMap<>();
...
//            if(hashCodeLookup.containsKey(sh.hashCode())) {
//                System.out.println(sh.equals(hashCodeLookup.get(sh.hashCode())));
//                System.out.println(sh.s());
//                System.out.println(hashCodeLookup.get(sh.hashCode()).s());
//            }
//            hashCodeLookup.put(sh.hashCode(),sh);
