 ...
 */
package velexplanation.actions;
 ...
 * restrict the actions available within different product states in planning.
 *
 * @author dkasenberg
 */
public class RestrictedActionType extends WrapperActionType {
    ...
    public RestrictedActionType(ActionType a, Collection<Action> applicableActions, HashableStateFactory hf) {
        super(a);
        this.hashingFactory = hf;
        this.generalApplicableActions = new ArrayList<>(applicableActions);
    }

    public RestrictedActionType(ActionType a, HashableStateFactory hf) {
        super(a);
        this.hashingFactory = hf;
        this.generalApplicableActions = null;
    }
     ...
     */
    public void setActionRestriction(Collection<Action> actions) {
        this.generalApplicableActions = new ArrayList<>(actions);
    }
