...
public abstract class Formula {
    ...
    public Formula applyGrounding(Map<String, String> grounding) {
        Formula toReturn = this;
        for (String param : grounding.keySet()) {
            toReturn = toReturn.applyParam(param, grounding.get(param));
        }
        return toReturn;
    }
