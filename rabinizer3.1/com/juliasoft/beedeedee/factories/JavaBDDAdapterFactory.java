...
public class JavaBDDAdapterFactory extends BDDFactory {
     ...
     *
     * @param x     1 if the garbage collection starts, 0 if it completes
     * @param stats statistics about the effect of the last garbage collection
     */
     ...
     * set of binary decision nodes.
     *
     * @param oldSize the old size of the table of nodes
     * @param newSize the new size of the table of nodes
     */
